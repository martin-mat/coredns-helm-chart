...
| `securityContext`                              | securityContext of the CoreDNS container; the defaults satisfy the `restricted` Pod Security Standard                                     | non-root 65532, NET_BIND_SERVICE only, RuntimeDefault seccomp |
